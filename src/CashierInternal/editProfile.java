...
public class editProfile extends javax.swing.JFrame {
    ...
    private void loadUserData() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "User load failed: "+e.getMessage());
        }
    }
    ...
    private void loadUserPhoto(){
        try{
            String sql = "SELECT photo FROM tbl_users WHERE id=?";
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lname, javax.swing.GroupLayout.DEFAULT_SIZE, 279, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               new editProfile(Session.id).setVisible(true); // pass the logged-in user's id
            }
        });
    }
