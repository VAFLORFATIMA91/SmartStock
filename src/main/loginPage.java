...
public class loginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/envelope.png"))); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        try {
            ...
            String sql = "SELECT id, first_name, last_name, email, password, status, role FROM tbl_users WHERE email=?";
            ...
            // Check password
            if (!dbPassword.equals(hashPassword(passwordText))) {
                JOptionPane.showMessageDialog(this, "Incorrect password");
                return;
            }

            if (!status.equalsIgnoreCase("APPROVED")) {
                JOptionPane.showMessageDialog(this, "Your account is not yet approved by the admin.");
                return;
            }

            // Set session
            Session.id = rs.getInt("id");
            Session.first_name = rs.getString("first_name");
            Session.last_name = rs.getString("last_name");
